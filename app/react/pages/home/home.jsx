          ...
          <div className="container-dynamic">
            ...
            <div className="row">
              <div className="col-xs-4 mb-3">
                <div className="row">
                  <div className="col-xs-12 col-sm-4">
                    <a href="https://www.sloan.org/" target="_blank"><img src="/assets/img/logo-sloan@2x.jpg"/></a>
                  </div>
              ...
              <div className="col-xs-4">
                <div className="row">
                  <div className="col-xs-12 col-sm-4">
                    <a href="https://helmsleytrust.org/" target="_blank"><img src="/assets/img/logo-helmsley@2x.jpg"/></a>
                  </div>
