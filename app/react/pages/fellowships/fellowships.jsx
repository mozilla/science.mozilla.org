            ...
            <div className="py-3" name="Fellows" slug="fellows" iconDefault="/assets/img/icon-tab-fellows.svg" iconActive="/assets/img/icon-tab-fellows-blue.svg">
              ...
              <div className="row my-3">
                ...
                <div className="col-sm-9">
                  ...
                  <p className="mb-1"><a href="https://twitter.com/blahah404" target="_blank">@blahah404</a> | <a href="http://rik.smith-unna.com/" target="_blank">Richard's Blog</a></p>
              ...
              <div className="row my-3">
                ...
                <div className="col-sm-9">
                  ...
                  <p className="mb-1"><a href="https://twitter.com/jasonbobe" target="_blank">@jasonbobe</a> | <a href="http://blog.jasonbobe.net/" target="_blank">Jason's Blog</a></p>
