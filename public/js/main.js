...
/***/ function(module, exports) {
	    ...
	    return (
	      React.createElement("div", {className: "pure-u-1-2 pure-u-md-1-4 pure-u-lg-1-6 person-card"}, 
	        React.createElement("div", null, 
	          ...
	          React.createElement("span", null, " ", person.title ? person.title + ", Mozilla Science Lab" : person.company, " ")
	        )
	      )
	    );
	  }
	...
	if(document.getElementById('event-projects')){
	  React.render(
	    React.createElement(FeatureBox, {load_id: "event-projects", url: "/api/events/x/projects"}),
